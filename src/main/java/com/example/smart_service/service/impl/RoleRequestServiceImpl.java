...
public class RoleRequestServiceImpl implements RoleRequestService {
    ...
    public RoleResponse createRequest(com.example.smart_service.dto.request.RoleRequest dto, String authHeader) {
        ...
        com.example.smart_service.entity.RoleRequestEntity entity = new com.example.smart_service.entity.RoleRequestEntity();
        entity.setUser(userEntity);
        entity.setStatus("PENDING");
        entity.setBusinessName(dto.getBusinessName());
        entity.setBusinessBio(dto.getBusinessBio());

        com.example.smart_service.entity.RoleRequestEntity saved = requestRepo.save(entity);
